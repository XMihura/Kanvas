# Kanvas Workflow Skill

Use this skill whenever the user asks you to manage tasks, check the board, or work on project items tracked in an Obsidian Canvas file.
